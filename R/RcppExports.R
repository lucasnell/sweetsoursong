...
#' @export
landscape_ode <- function(m, R, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, P_max, q, X, w, z, Y0, B0, N0, dt = 0.1, max_t = 90.0) {
    .Call(`_sweetsoursong_landscape_ode`, m, R, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, P_max, q, X, w, z, Y0, B0, N0, dt, max_t)
}

#' @export
landscape_constantF_ode <- function(m, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, q, X, Y0, B0, dt = 0.1, max_t = 90.0) {
    .Call(`_sweetsoursong_landscape_constantF_ode`, m, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, q, X, Y0, B0, dt, max_t)
}
...
#' @export
one_plant_mP_ode <- function(m, R, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, r, P_max, q, s_0, h, f_0, u, dt = 0.1, max_t = 90.0, Y0 = 1.0, B0 = 1.0, N0 = 1.0, P0 = 1.0) {
