...
#' @export
landscape_ode <- function(m, R, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, P_max, u, q, W, a, z, min_F_for_P, Y0, B0, N0, dt = 0.1, max_t = 90.0) {
    .Call(`_sweetsoursong_landscape_ode`, m, R, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, P_max, u, q, W, a, z, min_F_for_P, Y0, B0, N0, dt, max_t)
}
...
#' @export
landscape_season_ode <- function(m, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, P_max, u, q, W, R_hat, par1, par2, distr_types, a, z, min_F_for_P, Y0, B0, add_F = 1.0, dt = 0.1, max_t = 90.0) {
    .Call(`_sweetsoursong_landscape_season_ode`, m, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, P_max, u, q, W, R_hat, par1, par2, distr_types, a, z, min_F_for_P, Y0, B0, add_F, dt, max_t)
}
