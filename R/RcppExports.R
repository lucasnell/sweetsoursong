...
plant_metacomm_stoch_cpp <- function(n_reps, m, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, u, X, Y0, B0, n_sigma, season_len, season_surv, rand_season, open_sys, dt, max_t, burnin) {
    .Call(`_sweetsoursong_plant_metacomm_stoch_cpp`, n_reps, m, d_yp, d_b0, d_bp, g_yp, g_b0, g_bp, L_0, u, X, Y0, B0, n_sigma, season_len, season_surv, rand_season, open_sys, dt, max_t, burnin)
}
